...
class DocumentsImporter extends BaseImporter
{
    ...
    protected function getColumnMapping(): array
    {
        return [
            ...
            'lawyer' => 'lawyer',
            'القسم' => 'department',
            'الموظف الإداري' => 'admin_staff',
            'المحامي' => 'lawyer',
            'matter_id' => 'legacy_matter_name',
        ];
    }
    ...
    protected function processRow(array $row): void
    {
        ...
        $data = [
            ...
            'legacy_matter_name' => $this->cleanString($row['legacy_matter_name'] ?? null),
            'department' => $this->cleanString($row['department'] ?? null),
            'admin_staff' => $this->cleanString($row['admin_staff'] ?? null),
            'lawyer' => $this->cleanString($row['lawyer'] ?? null),
