...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="hearings-templates" class="card border-info mb-4" style="display: none;">
                            <div class="card-header bg-light">
                                ...
                                <strong><?php echo e(__('app.hearings_import_templates')); ?></strong>
                            </div>
                            <div class="card-body">
                                <p class="text-muted small mb-3">
                                    <?php echo e(__('app.download_template_generated_from_schema')); ?>
                                ...
                                <div>
                                    <div class="d-flex align-items-center mb-2">
                                        <strong class="me-2"><?php echo e(__('app.hearings_template')); ?></strong>
                                        <span class="badge bg-info"><?php echo e(__('app.template')); ?></span>
                                    </div>
                                    <p class="small text-muted mb-2">
                                        <?php echo e(__('app.hearings_template_description')); ?>

                                    </p>
                                    <div class="btn-group">
                                        <a href="<?php echo e(route('hearings.template.csv')); ?>"
                                           class="btn btn-outline-info btn-sm"
                                           title="<?php echo e(__('app.download_csv_template')); ?>">
                                            <i class="bi bi-file-earmark-text"></i> CSV
                                        </a>
                                        <a href="<?php echo e(route('hearings.template.xlsx')); ?>"
                                           class="btn btn-outline-info btn-sm"
                                           title="<?php echo e(__('app.download_xlsx_template')); ?>">
                                            <i class="bi bi-file-earmark-excel"></i> Excel
                                        </a>
