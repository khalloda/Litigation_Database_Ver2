            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.circuit) {
                        ...
                        $('#matter_circuit').append(new Option('<?php echo e(__("app.select_option")); ?>', '', true, true));
                    }
                    ...
                    if (data.secretary) {
                        ...
                        $('#circuit_secretary').append(new Option('<?php echo e(__("app.select_option")); ?>', '', true, true));
                    }
                    ...
                    if (data.floor) {
                        ...
                        $('#court_floor').append(new Option('<?php echo e(__("app.select_option")); ?>', '', true, true));
                    }
                    ...
                    if (data.hall) {
                        ...
                        $('#court_hall').append(new Option('<?php echo e(__("app.select_option")); ?>', '', true, true));
                    }
