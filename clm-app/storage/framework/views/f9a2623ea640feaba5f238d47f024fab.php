        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><?php echo e(__('app.edit_admin_subtask')); ?></h5>
                    <a href="<?php echo e(route('admin-subtasks.show', $adminSubtask)); ?>" class="btn btn-secondary btn-sm"><?php echo e(__('app.back')); ?></a>
                </div>

                <div class="card-body">
                    <form action="<?php echo e(route('admin-subtasks.update', $adminSubtask)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($task->id); ?>" <?php echo e((old('task_id', $adminSubtask->task_id) == $task->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $lawyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lawyer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lawyer->id); ?>" <?php echo e((old('lawyer_id', $adminSubtask->lawyer_id) == $lawyer->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('performer', $adminSubtask->performer)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="report" id="report" class="form-check-input" value="1" <?php echo e(old('report', $adminSubtask->report) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('next_date', $adminSubtask->next_date ? $adminSubtask->next_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('procedure_date', $adminSubtask->procedure_date ? $adminSubtask->procedure_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('result', $adminSubtask->result)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo e(route('admin-subtasks.show', $adminSubtask)); ?>" class="btn btn-secondary"><?php echo e(__('app.cancel')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views\admin-subtasks\edit.blade.php ENDPATH**/ ?>