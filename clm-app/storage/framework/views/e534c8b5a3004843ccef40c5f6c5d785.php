<?php $__env->startSection('title', __('app.edit_client')); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h4"><?php echo e(__('app.edit_client')); ?></h1>
        <a href="<?php echo e(route('clients.show', $client)); ?>" class="btn btn-outline-secondary">← <?php echo e(__('app.back')); ?></a>
    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('mfiles_id', $client->mfiles_id)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('client_code', $client->client_code)); ?>" maxlength="50">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('client_name_ar', $client->client_name_ar)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('client_name_en', $client->client_name_en)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('client_print_name', $client->client_print_name)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(old('cash_or_probono_id', $client->cash_or_probono_id) == $option->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(old('status_id', $client->status_id) == $option->id ? 'selected' : ''); ?>>
                                <?php echo e($option->label); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('client_start', $client->client_start)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('client_end', $client->client_end)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="<?php echo e($lawyer->id); ?>" <?php echo e(old('contact_lawyer_id', $client->contact_lawyer_id) == $lawyer->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" accept="image/*">
                        <?php if($client->logo && file_exists(storage_path('app/public/logos/' . $client->logo))): ?>
                        <div class="mt-2">
                            <small class="text-muted"><?php echo e(__('app.current_logo')); ?>:</small><br>
                            <img src="<?php echo e(asset('storage/logos/' . $client->logo)); ?>" alt="Current logo" class="img-thumbnail" style="max-height: 50px;">
                        </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(old('power_of_attorney_location_id', $client->power_of_attorney_location_id) == $option->id ? 'selected' : ''); ?>>
                                <?php echo e($option->label); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(old('documents_location_id', $client->documents_location_id) == $option->id ? 'selected' : ''); ?>>
                                <?php echo e($option->label); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-3 d-flex justify-content-end gap-2">
                    <a href="<?php echo e(route('clients.show', $client)); ?>" class="btn btn-secondary"><?php echo e(__('app.cancel')); ?></a>
                    <button type="submit" class="btn btn-primary"><?php echo e(__('app.update_client')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views\clients\edit.blade.php ENDPATH**/ ?>