        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><?php echo e(__('app.create_option_set')); ?></h4>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.options.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>

                        <div class="mb-3">
                            <label for="key" class="form-label"><?php echo e(__('app.key')); ?> <span class="text-danger">*</span></label>
                            <input type="text"
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                required>
                            <div class="form-text"><?php echo e(__('app.key_help_text')); ?></div>
                            <?php $__errorArgs = ['key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                id="description_en"
                                name="description_en"
                                rows="3"><?php echo e(old('description_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                id="description_ar"
                                name="description_ar"
                                rows="3"><?php echo e(old('description_ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> <?php echo e(__('app.create')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views\admin\options\create.blade.php ENDPATH**/ ?>