        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><?php echo e(__('app.create_engagement_letter')); ?></h3>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('engagement-letters.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('contract_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> <?php echo e(__('app.create_engagement_letter')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views/engagement-letters/create.blade.php ENDPATH**/ ?>