                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="opponentSearch" class="form-label">
                            <?php echo e(__('app.search_opponent')); ?> <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <input type="text"
                                   class="form-control"
                                   id="opponentSearch"
                                   placeholder="<?php echo e(__('app.type_to_search_opponents')); ?>"
                                   autocomplete="off">
                        ...
                        <div class="form-text">
                            <?php echo e(__('app.opponent_search_help')); ?>
                    ...
                    <div id="selectedOpponent" class="mb-3" style="display: none;">
                        <label class="form-label"><?php echo e(__('app.selected_opponent')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="opponentCapacity" class="form-label">
                            <?php echo e(__('app.capacity')); ?>

                        </label>
                        <select class="form-select" id="opponentCapacity" name="capacity_id">
                            <option value=""><?php echo e(__('app.no_capacity')); ?></option>
                            <?php $__currentLoopData = \App\Models\OptionValue::where('set_id', 3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capacity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($capacity->id); ?>">
                                    ...
                                    <?php if($capacity->label_ar && $capacity->label_ar !== $capacity->label_en): ?>
                                        (<?php echo e($capacity->label_ar); ?>)
                                    <?php endif; ?>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <div class="form-text">
                            <?php echo e(__('app.capacity_help')); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               id="opponentAlias"
                               name="alias_text"
                               placeholder="<?php echo e(__('app.optional_alias_text')); ?>"
                               maxlength="191">
                        <div class="form-text">
                            <?php echo e(__('app.alias_help')); ?>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="setAsPrimary">
                                <?php echo e(__('app.set_as_primary_opponent')); ?>

                            </label>
                        </div>
                        <div class="form-text">
                            <?php echo e(__('app.primary_opponent_help')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function searchOpponents(query) {
        fetch(`<?php echo e(route('opponents.search')); ?>?q=${encodeURIComponent(query)}`)
            ...
            .catch(error => {
                ...
                searchResults.innerHTML = '<div class="text-danger"><?php echo e(__("app.error_searching_opponents")); ?></div>';
    ...
    function displaySearchResults(opponents) {
        if (opponents.length === 0) {
            searchResults.innerHTML = '<div class="text-muted"><?php echo e(__("app.no_opponents_found")); ?></div>';
        } else {
    ...
    function addOpponent() {
        ...
        addOpponentBtn.disabled = true;
        addOpponentBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-1"></i><?php echo e(__("app.adding")); ?>...';

        fetch('<?php echo e(route("case-opponents.store", $case)); ?>', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                showAlert('danger', data.message || '<?php echo e(__("app.error_adding_opponent")); ?>');
                addOpponentBtn.disabled = false;
                addOpponentBtn.innerHTML = '<i class="fas fa-plus me-1"></i><?php echo e(__("app.add_opponent")); ?>';
            }
        })
        .catch(error => {
            console.error('Error:', error);
            showAlert('danger', '<?php echo e(__("app.error_adding_opponent")); ?>');
            addOpponentBtn.disabled = false;
            addOpponentBtn.innerHTML = '<i class="fas fa-plus me-1"></i><?php echo e(__("app.add_opponent")); ?>';
        });
    }
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views/cases/partials/_add_opponent.blade.php ENDPATH**/ ?>