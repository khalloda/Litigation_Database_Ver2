        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><?php echo e(__('app.edit_contact')); ?></h3>
                    <a href="<?php echo e(route('contacts.show', $contact)); ?>" class="btn btn-secondary">
...
unset($__errorArgs, $__bag); ?>" id="client_id" name="client_id" required>
                                        ...
                                        <option value="<?php echo e($client->id); ?>" <?php echo e((old('client_id', $contact->client_id) == $client->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('contact_name', $contact->contact_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="contact_type" name="contact_type" required>
                                        ...
                                        <option value="phone" <?php echo e((old('contact_type', $contact->contact_type) == 'phone') ? 'selected' : ''); ?>><?php echo e(__('app.phone')); ?></option>
                                        <option value="mobile" <?php echo e((old('contact_type', $contact->contact_type) == 'mobile') ? 'selected' : ''); ?>><?php echo e(__('app.mobile')); ?></option>
                                        <option value="email" <?php echo e((old('contact_type', $contact->contact_type) == 'email') ? 'selected' : ''); ?>><?php echo e(__('app.email')); ?></option>
                                        <option value="fax" <?php echo e((old('contact_type', $contact->contact_type) == 'fax') ? 'selected' : ''); ?>><?php echo e(__('app.fax')); ?></option>
                                        <option value="website" <?php echo e((old('contact_type', $contact->contact_type) == 'website') ? 'selected' : ''); ?>><?php echo e(__('app.website')); ?></option>
                                        <option value="address" <?php echo e((old('contact_type', $contact->contact_type) == 'address') ? 'selected' : ''); ?>><?php echo e(__('app.address')); ?></option>
                                        <option value="other" <?php echo e((old('contact_type', $contact->contact_type) == 'other') ? 'selected' : ''); ?>><?php echo e(__('app.other')); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('contact_value', $contact->contact_value)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_primary" name="is_primary" value="1"
                                            <?php echo e(old('is_primary', $contact->is_primary) ? 'checked' : ''); ?>>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> <?php echo e(__('app.update_contact')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views\contacts\edit.blade.php ENDPATH**/ ?>