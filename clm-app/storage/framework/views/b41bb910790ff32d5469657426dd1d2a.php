    ...
    <tr>
      ...
      <th>
        <div class="btn-group btn-group-sm">
          <button type="button" class="btn btn-success" id="accept-all"><?php echo app('translator')->get('app.accept_all'); ?></button>
          <button type="button" class="btn btn-info" id="accept-all-strong"><?php echo app('translator')->get('app.accept_all_strong'); ?></button>
