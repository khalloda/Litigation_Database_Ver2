...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(in_array($option->id, old('court_circuits', [])) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(in_array($option->id, old('court_secretaries', [])) ? 'selected' : ''); ?>>
                                <?php echo e(app()->getLocale() === 'ar' ? $option->label_ar : $option->label_en); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(in_array($option->id, old('court_floors', [])) ? 'selected' : ''); ?>>
                                <?php echo e(app()->getLocale() === 'ar' ? $option->label_ar : $option->label_en); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="<?php echo e($option->id); ?>" <?php echo e(in_array($option->id, old('court_halls', [])) ? 'selected' : ''); ?>>
                                <?php echo e(app()->getLocale() === 'ar' ? $option->label_ar : $option->label_en); ?>
