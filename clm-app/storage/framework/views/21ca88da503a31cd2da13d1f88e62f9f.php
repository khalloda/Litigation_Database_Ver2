<div class="tab-pane <?php echo e($active ? 'show active' : ''); ?>" id="<?php echo e($section); ?>-tab" role="tabpanel" aria-labelledby="<?php echo e($section); ?>-tab-btn" style="<?php echo e($active ? '' : 'display: none;'); ?>">
    <div class="card">
        <div class="card-body">
...
<?php /**PATH D:\Claude\Litigation_Database_Ver2\Litigation_Database_Ver2\clm-app\resources\views\cases\partials\_tab_section.blade.php ENDPATH**/ ?>