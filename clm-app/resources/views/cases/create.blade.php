            ...
            <form action="{{ route('cases.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" maxlength="10" class="form-control @error('matter_shelf') is-invalid @enderror" id="matter_shelf" name="matter_shelf" value="{{ old('matter_shelf') }}">
                        @error('matter_shelf')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('engagement_letter_no') is-invalid @enderror" id="engagement_letter_no" name="engagement_letter_no" value="{{ old('engagement_letter_no') }}">
