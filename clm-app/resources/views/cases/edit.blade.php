            ...
            <form action="{{ route('cases.update', $case) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('client_in_case_name') is-invalid @enderror" id="client_in_case_name" name="client_in_case_name" value="{{ old('client_in_case_name', $case->client_in_case_name) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select select2-cascade @error('circuit_name_id') is-invalid @enderror"
                                                id="circuit_name_id" name="circuit_name_id" {{ $case->court_id ? '' : 'disabled' }}>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select select2-cascade @error('circuit_serial_id') is-invalid @enderror"
                                                id="circuit_serial_id" name="circuit_serial_id" {{ $case->court_id ? '' : 'disabled' }}>
                                            <option value="">{{ __('app.select_court_first') }}</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select select2-cascade @error('circuit_shift_id') is-invalid @enderror"
                                                id="circuit_shift_id" name="circuit_shift_id" {{ $case->court_id ? '' : 'disabled' }}>
                                            <option value="">{{ __('app.select_court_first') }}</option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('client_capacity_note') is-invalid @enderror" id="client_capacity_note" name="client_capacity_note" value="{{ old('client_capacity_note', $case->client_capacity_note) }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('opponent_id') is-invalid @enderror" id="opponent_id" name="opponent_id">
                            ...
                            <option value="{{ $opp->id }}" {{ (old('opponent_id', $case->opponent_id) == $opp->id) ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('opponent_in_case_name') is-invalid @enderror" id="opponent_in_case_name" name="opponent_in_case_name" value="{{ old('opponent_in_case_name', $case->opponent_in_case_name) }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('opponent_capacity_note') is-invalid @enderror" id="opponent_capacity_note" name="opponent_capacity_note" value="{{ old('opponent_capacity_note', $case->opponent_capacity_note) }}">
