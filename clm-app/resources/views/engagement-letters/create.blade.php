        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('app.create_engagement_letter') }}</h3>
                    <a href="{{ route('engagement-letters.index') }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> {{ __('app.back_to_list') }}
                    </a>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('engagement-letters.store') }}">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('app.create_engagement_letter') }}
                            </button>
                        </div>
                    </form>
                </div>
