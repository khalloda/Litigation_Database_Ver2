                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2 @error('court_circuit') is-invalid @enderror" 
                            ...
                            <option value="{{ $option->id }}" {{ (old('court_circuit', $court->court_circuit) == $option->id) ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2 @error('court_circuit_secretary') is-invalid @enderror" 
                            ...
                            <option value="{{ $option->id }}" {{ (old('court_circuit_secretary', $court->court_circuit_secretary) == $option->id) ? 'selected' : '' }}>
                                {{ app()->getLocale() === 'ar' ? $option->label_ar : $option->label_en }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2 @error('court_floor') is-invalid @enderror" 
                            ...
                            <option value="{{ $option->id }}" {{ (old('court_floor', $court->court_floor) == $option->id) ? 'selected' : '' }}>
                                {{ app()->getLocale() === 'ar' ? $option->label_ar : $option->label_en }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2 @error('court_hall') is-invalid @enderror" 
                            ...
                            <option value="{{ $option->id }}" {{ (old('court_hall', $court->court_hall) == $option->id) ? 'selected' : '' }}>
                                {{ app()->getLocale() === 'ar' ? $option->label_ar : $option->label_en }}
                            </option>
                            @endforeach
                        </select>
