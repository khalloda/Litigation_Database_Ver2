...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h4">{{ __('app.edit_client') }}</h1>
        <a href="{{ route('clients.show', $client) }}" class="btn btn-outline-secondary">← {{ __('app.back') }}</a>
    </div>
            ...
            <form action="{{ route('clients.update', $client) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="client_name_ar" class="form-control @error('client_name_ar') is-invalid @enderror" value="{{ old('client_name_ar', $client->client_name_ar) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="client_name_en" class="form-control @error('client_name_en') is-invalid @enderror" value="{{ old('client_name_en', $client->client_name_en) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="client_print_name" class="form-control @error('client_print_name') is-invalid @enderror" value="{{ old('client_print_name', $client->client_print_name) }}">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                        ...
                        <select name="cash_or_probono_id" class="form-select @error('cash_or_probono_id') is-invalid @enderror">
                            ...
                            <option value="{{ $option->id }}" {{ old('cash_or_probono_id', $client->cash_or_probono_id) == $option->id ? 'selected' : '' }}>
                                {{ $option->label }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status_id" class="form-select @error('status_id') is-invalid @enderror">
                            ...
                            <option value="{{ $option->id }}" {{ old('status_id', $client->status_id) == $option->id ? 'selected' : '' }}>
                                {{ $option->label }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="client_start" class="form-control @error('client_start') is-invalid @enderror" value="{{ old('client_start', $client->client_start) }}">
                        @error('client_start')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="date" name="client_end" class="form-control @error('client_end') is-invalid @enderror" value="{{ old('client_end', $client->client_end) }}">
                        @error('client_end')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <select name="contact_lawyer_id" class="form-select @error('contact_lawyer_id') is-invalid @enderror">
                            ...
                            <option value="{{ $lawyer->id }}" {{ old('contact_lawyer_id', $client->contact_lawyer_id) == $lawyer->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($client->logo && file_exists(storage_path('app/public/logos/' . $client->logo)))
                        <div class="mt-2">
                            <small class="text-muted">{{ __('app.current_logo') }}:</small><br>
                            <img src="{{ asset('storage/logos/' . $client->logo) }}" alt="Current logo" class="img-thumbnail" style="max-height: 50px;">
                        </div>
                        @endif
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <select name="power_of_attorney_location_id" class="form-select @error('power_of_attorney_location_id') is-invalid @enderror">
                            ...
                            <option value="{{ $option->id }}" {{ old('power_of_attorney_location_id', $client->power_of_attorney_location_id) == $option->id ? 'selected' : '' }}>
                                {{ $option->label }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="documents_location_id" class="form-select @error('documents_location_id') is-invalid @enderror">
                            ...
                            <option value="{{ $option->id }}" {{ old('documents_location_id', $client->documents_location_id) == $option->id ? 'selected' : '' }}>
                                {{ $option->label }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="mt-3 d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('app.update_client') }}</button>
                </div>
            </form>
        </div>
    </div>
