            ...
            <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="mfiles_id" class="form-control @error('mfiles_id') is-invalid @enderror" value="{{ old('mfiles_id') }}" min="1">
                        @error('mfiles_id')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="client_code" class="form-control @error('client_code') is-invalid @enderror" value="{{ old('client_code') }}" maxlength="50">
                        @error('client_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
