            ...
            <form action="{{ route('lawyers.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('lawyer_name_title') is-invalid @enderror" id="lawyer_name_title" name="lawyer_name_title" value="{{ old('lawyer_name_title') }}">
