...
return [
    ...
    'loading_choices' => 'Loading choices...',
    'preparing_create_form' => 'Preparing create form...',
    'no_existing_values_found' => 'No existing values found',
    'cannot_create_new_value' => 'Cannot create new value for this field',
    'create_new' => 'Create New',
    'apply_choice' => 'Apply Choice',
    ...
    'opponent_suggestions' => 'Opponent Suggestions',
    ...
    'accept_all_strong' => 'Accept All Strong',
    'reject_all_low' => 'Reject All Low',
    'use_suggestion' => 'Use Suggestion',
    'keep_as_new' => 'Keep as New',
    'more_options' => 'More Options',
    'choose_opponent' => 'Choose Opponent',
    'also_store_alias' => 'Also store as alias',
    'save_choices_r' => 'Save Choices',
    'show_more' => 'Show More',
    'show_less' => 'Show Less',
    'yes' => 'Yes',
    'no' => 'No',
    ...
    'documents_hearings' => 'Documents & Hearings',
    ...
    'case_opponents_instruction_2' => 'Use this template to add multiple opponents to existing cases',
    'case_opponents_instruction_3' => 'Provide either case_id or case_number for each opponent',
    'case_opponents_instruction_4' => 'Only one opponent per case can be marked as primary',
    ...
    'reports_page' => [
        'title' => 'Reports',
        'client_cases_report_title' => 'Client Case Report',
        'case_status_distribution' => 'Case Status Distribution',
        'partner_caseload' => 'Partner Caseload',
        'top_clients' => 'Top Clients by Case Count',
        'upcoming_hearings' => 'Upcoming Hearings',
        'select_client_label' => 'Select Client',
        'select_client_placeholder' => '-- Select a client --',
        'select_client_warning' => 'Please select a client before generating the report.',
        'select_columns_label' => 'Select Columns',
        'reset_columns' => 'Reset All',
        'column_toggle_hint' => 'Toggle columns to include or exclude from the report.',
        'orientation_label' => 'PDF Orientation',
        'orientation_portrait' => 'Portrait',
        'orientation_landscape' => 'Landscape',
        'status_filter_label' => 'Case Status Filter',
        'status_filter_all' => 'All Cases',
        'status_filter_active' => 'Active (سارية)',
        'status_filter_closed' => 'Closed (منتهية)',
        'generate_pdf' => 'Generate PDF Report',
        'generating_pdf' => 'Generating PDF...',
        'report_error_generic' => 'An error occurred while generating the report. Please try again.',
        'columns' => [
            'serial' => 'Serial #',
            'matter' => 'Matter Name (Arabic)',
            'court' => 'Court Name (Arabic)',
            'clientRole' => 'Client & Capacity',
            'opponentRole' => 'Opponent & Capacity',
            'subject' => 'Matter Description',
            'latestDecision' => 'Latest Decision',
            'evaluation' => 'Matter Evaluation',
            'financialProvision' => 'Financial Provision',
        ],
    ],
    ...
    'reports' => [
        ...
        'case_status_dashboard' => [
            ...
            'overview' => 'At-a-glance case overview with summary statistics',
            'total_cases' => 'Total Cases',
            'active_cases' => 'Active Cases',
            'closed_cases' => 'Closed Cases',
            'attention_required' => 'Attention Required',
            'by_category' => 'Cases by Category',
            'by_court' => 'Cases by Court',
            'cases_requiring_attention' => 'Cases Requiring Attention',
            'case_name' => 'Case Name',
            'client_name' => 'Client Name',
            'reason' => 'Reason',
            'reason_overdue_task' => 'Overdue Task',
            'reason_missing_data' => 'Missing Data',
            'reason_upcoming_hearing' => 'Upcoming Hearing',
        ...
        'admin_tasks' => [
            ...
            'detailed' => 'Detailed',
            'overdue' => 'Overdue',
            'group_by_lawyer' => 'By Lawyer',
            'group_by_case' => 'By Case',
        ...
        'document_inventory' => [
            ...
            'storage_type_both' => 'Both',
            'movement_card' => 'Movement Card',
            'missing_documents_section' => 'Cases with Missing Documents',
            'description' => 'Description',
            'serial' => 'Serial',
            'file_size' => 'File Size',
            'reason_no_documents' => 'No documents found for this case',
        ],
    ],
];
