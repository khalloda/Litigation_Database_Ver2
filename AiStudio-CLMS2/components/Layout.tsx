...
import { CaseIcon, ReportIcon, SettingsIcon, TaskIcon, LanguageIcon, ClientIcon, OpponentIcon, UserIcon, CourtIcon, CalendarIcon, DocumentIcon, DashboardIcon } from './icons';
    ...
    return (
        <aside className="w-64 bg-white border-e shadow-sm flex-shrink-0 flex flex-col p-4">
            ...
            <nav className="mt-8 flex flex-col gap-2">
                <NavItem icon={<DashboardIcon />} label={t('app.dashboard')} active={currentView === ''} onClick={() => onNavigate('/')} />
